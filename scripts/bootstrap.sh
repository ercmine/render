...
log ""
log "SDL3 and bgfx/bx/bimg are required for runtime targets. Configure via RENDER_SDL3_ROOT and RENDER_BGFX_ROOT, vendoring third_party/SDL3 and third_party/bgfx.cmake, or RENDER_ALLOW_FETCHCONTENT=ON."
