...
Write-Host ''
Write-Host 'SDL3 is required for runtime targets. Configure via RENDER_SDL3_ROOT, vendoring third_party/SDL3, system package, or RENDER_ALLOW_FETCHCONTENT=ON.'
